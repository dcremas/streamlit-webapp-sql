...
- Designing and implementing a full functioning Web Application on Heroku via Streamlit front-end.
- Harnessing a back-end Postgres database hosted on AWS RDS to enable text to SQL interactivity.
